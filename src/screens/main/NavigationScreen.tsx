...
import { ArchiveIcon, FileIcon, NotificationsIcon, ProfileIcon } from "../../components/icons/BottomBarIcons";
...
export default function NavigationScreen({ navigation, route }: any) {
  ...
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }} tabBar={props => (<BottomNavBar props={props} isVisible={isVisible} />)
    }>
      <Tab.Screen
